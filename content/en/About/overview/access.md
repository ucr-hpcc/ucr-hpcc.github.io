...
The registration provides access to the following resources: 
  ...
  * Over 16,000 CPU cores (60% AMD and 40% Intel), ~230,000 cuda cores (Nvidia A100, H100, A6000 Ada, RTX Pro 6000 Blackwell, P100 and K80 GPUs), ~6PB parallel GPFS-based disk space, 512GB-1TB of memory/node, etc. More details are available on the [hardware pages](https://hpcc.ucr.edu/about/hardware/).
