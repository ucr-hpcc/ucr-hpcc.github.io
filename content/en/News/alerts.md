...
__[21 Jul 2026] HPCC Emergency Cluster Update Shutdown__

UCR HPCC will be installing and testing a critical security update for the cluster between the following times:

* Start: **Tuesday, Jul 21 2026, 8am**
* End:   **Tuesday, Jul 21 2026, 8pm**

The security issue affects almost all Linux-based systems worldwide, not just UCR HPCC.

Impacted Services will include cluster access - SSH, Slurm, data access (including HTTP access), and all OnDemand Services. Normal email
support should remain online.
...
"ReqNodeNotAvail", you may resubmit your job with a shorter duration. Otherwise you may leave your job in the queue, where it will progress
as soon as maintenance completes.

If you have a job in progress, and it does not complete before the maintenance window, it will be terminated and requeued for some time
after maintenance.

We apologize for the disruption that this shutdown will cause.
...
__SOP for unscheduled outages__
...
__SOP for scheduled shutdowns__
