...
### Jupyter
You can run jupyter as an interactive job using [tunneling](/hpc_cluster/package_manage/#jupyter), or you can use the web portal [Jupyter-Hub](https://jupyter.hpcc.ucr.edu).
