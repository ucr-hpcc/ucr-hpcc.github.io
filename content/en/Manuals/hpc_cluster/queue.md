...
|------------------|-----------------------------------------------------------|----------------------------|-------------------------------------------|--------------|
| epyc (2021 CPU)  | CPU Intensive Workloads, Multithreaded, MPI, OpenMP       | 384 Cores, 1TB memory [^7] | 64GB memory per Core [^1],[^4]            | 30 Days      |
...
| highclock        | Low Parallelism Workloads                                 | 32 Cores, 1TB memory       |                                           | 30 Days      |
